...
public class ClientInputCollector : BaseUserInputCollector
{
    ...
    protected override void ConfigureInputFields()
    {
        ...
        _inputFields.Add(new LocationInputField(() => GetUserInput("restaurant location (in the form of X,Y)")));
    }
    ...
    public Client CollectClientInfo()
    {
        ...
        // string restaurantName = GetUserInput("restaurant's name");
        // client.RestaurantName = restaurantName;
        //
        // string restaurantStyle = CollectRestaurantStyle();
        // client.RestaurantStyle = restaurantStyle;
        //
        // new LocationInputField(() => GetUserInput("restaurant location (in the form of X,Y)"))
        //     .Collect(client, _validationService);
